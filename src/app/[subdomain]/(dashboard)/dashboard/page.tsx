...
import CardTotalBuysDashboard from "@/components/card-total-buys-dashborad"
import CardTotalEmployeesDashboard from "@/components/card-total-employee-dashboard"
import CardTotalProvidersDashboard from "@/components/card-total-providers-dashboard"
import CardTotalSalesDashboard from "@/components/card-total-sales-dashboard"
    ...
    <DashboardShell>
      ...
      <div className="flex-grow overflow-y-auto md:pb-48 pb-64 max-h-screen scroll-smooth scroll-pt-px">
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mr-5">
          <CardTotalProvidersDashboard />
          <CardTotalEmployeesDashboard />
          <CardTotalSalesDashboard />
          <CardTotalBuysDashboard />
        </div>
