...
import { GetProductIDResponse } from "@/lib/queries/interfaces/product.interface"
...
interface SelectBranchProps {
  ...
  productId: GetProductIDResponse;
}

export function SelectCaEdit({ setUserCategory, productId }: SelectBranchProps) {
  ...
  useEffect(() => {
    if (productId?.data.product.categories) {
      setSelectedValues(productId?.data.product.categories.map(category => category.category) || []);
    }
  }, [productId]);
