...
export default function ViewProduct({ params: { id } }: EditProductProps) {

    const { subdomain, user } = useParamsClient();
    const { productId, isLoadingProductId, isErrorProductId } = useProducts(subdomain as never, user?.token, id.toString());
        ...
        <div className="grid gap-8 md:grid-cols-2 max-w-6xl mx-auto py-8 px-4">
            <div className="flex justify-center items-center">
                <div className="relative w-full max-w-[400px] ">
                    ...
                    <Image
                        src={productId?.data.product.images[0]!}
                        alt="Product Image"
