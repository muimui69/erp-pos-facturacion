        ...
        <div className="bg-background border rounded-lg p-4">
          ...
          <form className="grid gap-4">
            <div className="grid gap-2">
              ...
              <Input id="name" placeholder="Introduzca el nombre del Producto" />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="description" className="text-base">
                Descripcion
              </Label>
              <Textarea id="description" placeholder="Introduzca la Descripcion del Producto" className="min-h-[100px]" />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="price" className="text-base">
                Precio
              </Label>
              <Input id="price" type="number" placeholder="Introduzca el precio" />
            </div>
            <div className="grid gap-2">
